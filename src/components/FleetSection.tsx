...
const FleetSection = () => (
  <section id="fleet" className="border-t border-border py-24">
    <div className="section-container">
      <motion.p {...fadeUp()} className="data-mono text-xs uppercase tracking-[0.2em] text-gold">Fleet & Operations</motion.p>
      <motion.h2 {...fadeUp(0.05)} className="mt-3 max-w-xl text-3xl font-semibold text-foreground md:text-4xl">Premium Assets, Institutional Standards</motion.h2>
      ...
      <motion.div {...fadeUp(0.15)} className="glass-card mt-12 overflow-hidden">
      ...
      <div className="mt-8 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        {protocols.map((p, i) => (
          <motion.div key={p.label} {...fadeUp(0.2 + i * 0.05)} className="flex items-center gap-3 rounded-lg bg-secondary px-4 py-3">
