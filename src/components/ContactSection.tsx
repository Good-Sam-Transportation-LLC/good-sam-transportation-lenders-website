              ...
              <form onSubmit={handleSubmit} className="glass-card space-y-4 p-6 md:p-8">
                <div className="grid gap-4 sm:grid-cols-2">
                  <div>
                    ...
                    <input id="contact-name" name="fullName" required type="text" maxLength={100} className="w-full rounded-md border border-border bg-secondary px-3 py-2.5 text-sm text-foreground outline-none transition-colors focus:border-gold/50 focus:ring-1 focus:ring-gold/20" />
                  </div>
                  <div>
                    <label htmlFor="contact-firm" className="mb-1.5 block text-xs font-medium text-muted-foreground">Firm / Organization</label>
                    <input id="contact-firm" name="firm" type="text" maxLength={100} className="w-full rounded-md border border-border bg-secondary px-3 py-2.5 text-sm text-foreground outline-none transition-colors focus:border-gold/50 focus:ring-1 focus:ring-gold/20" />
                  </div>
                </div>
                <div>
                  <label htmlFor="contact-email" className="mb-1.5 block text-xs font-medium text-muted-foreground">Email Address</label>
                  <input id="contact-email" name="email" required type="email" maxLength={255} className="w-full rounded-md border border-border bg-secondary px-3 py-2.5 text-sm text-foreground outline-none transition-colors focus:border-gold/50 focus:ring-1 focus:ring-gold/20" />
                </div>
                <div>
                  ...
                  <select id="contact-interest" name="investmentInterest" className="w-full rounded-md border border-border bg-secondary px-3 py-2.5 text-sm text-foreground outline-none transition-colors focus:border-gold/50 focus:ring-1 focus:ring-gold/20">
                ...
                <div>
                  ...
                  <textarea id="contact-message" name="message" rows={3} maxLength={1000} className="w-full resize-none rounded-md border border-border bg-secondary px-3 py-2.5 text-sm text-foreground outline-none transition-colors focus:border-gold/50 focus:ring-1 focus:ring-gold/20" />
                </div>
